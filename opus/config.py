...
KITE_API_KEY = os.environ.get("SELF_API_KEY", "your_api_key_here")
KITE_API_SECRET = os.environ.get("SELF_API_SECRET", "your_api_secret_here")
KITE_ACCESS_TOKEN = os.environ.get("SELF_ACCESS_TOKEN", "")
