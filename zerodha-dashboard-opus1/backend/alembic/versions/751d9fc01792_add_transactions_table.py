...
Create Date: 2026-03-26 13:53:30.469759
...
def upgrade() -> None:
    ...
    op.create_index('idx_transactions_bank_account_date', 'transactions', ['bank_account_id', 'transaction_date'], unique=False, postgresql_ops={'transaction_date': 'DESC'})
    op.create_index('idx_transactions_filters', 'transactions', ['bank_account_id', 'transaction_date', 'transaction_type', 'category_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_transactions_filters', table_name='transactions')
    op.drop_index('idx_transactions_bank_account_date', table_name='transactions', postgresql_ops={'transaction_date': 'DESC'})
