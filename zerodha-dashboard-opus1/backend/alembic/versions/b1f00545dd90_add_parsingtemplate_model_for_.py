"""Add ParsingTemplate model for incremental intelligence

Revision ID: b1f00545dd90
Revises: 7c612302520e
Create Date: 2026-03-27 15:01:14.308601
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['parsing_template_id'], ['parsing_templates.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_bank_statements_bank_account_id'), 'bank_statements', ['bank_account_id'], unique=False)
    op.create_index(op.f('ix_bank_statements_parsing_template_id'), 'bank_statements', ['parsing_template_id'], unique=False)
    ...
    sa.Column('created_from_statement_id', sa.Integer(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['created_from_statement_id'], ['bank_statements.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_parsing_templates_bank_active', 'parsing_templates', ['bank_name', 'is_active'], unique=False)
    op.create_index(op.f('ix_parsing_templates_bank_name'), 'parsing_templates', ['bank_name'], unique=False)
    op.create_index(op.f('ix_parsing_templates_is_active'), 'parsing_templates', ['is_active'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_parsing_templates_is_active'), table_name='parsing_templates')
    op.drop_index(op.f('ix_parsing_templates_bank_name'), table_name='parsing_templates')
    op.drop_index('idx_parsing_templates_bank_active', table_name='parsing_templates')
    ...
    op.drop_index(op.f('ix_bank_statements_parsing_template_id'), table_name='bank_statements')
