...
export const useBankAccountsStore = defineStore('bankAccounts', {
  ...
  actions: {
    ...
    async fetchMonthlyIncomeExpenses(accountId, numMonths = 12) {
      this.analytics.monthlyIncomeExpenses = null
      try {
        const response = await api.getMonthlyIncomeExpenses(accountId, numMonths)
        this.analytics.monthlyIncomeExpenses = {
          months: response.data.months || [],
          income: response.data.income || [],
          expenses: response.data.expenses || [],
          net: response.data.net || [],
        }
        return this.analytics.monthlyIncomeExpenses
      } catch (error) {
        this.analytics.monthlyIncomeExpenses = null
        throw error
      }
