        ...
        <div class="tab-content">
          ...
          <div v-if="activeTab === 'overview'" class="overview-content">
            ...
            <div class="monthly-analysis-section">
              <h3 class="section-title">📊 Monthly Income &amp; Expenses</h3>
...
import MonthlyIncomeExpensesChart from '@/components/bank/MonthlyIncomeExpensesChart.vue'
...
const handleBankSelect = async (bank) => {
  ...
  if (bank) {
    ...
    try {
      monthlyData.value = await bankAccountsStore.fetchMonthlyIncomeExpenses(bank.id, 12)
    } catch {
      // silently ignore; chart shows empty state
    } finally {
